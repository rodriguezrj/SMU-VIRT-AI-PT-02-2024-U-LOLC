...
def build_marital_encoder(X_filled):
    marital_encoder = OneHotEncoder(handle_unknown='ignore', sparse_output=False)
...
def build_contact_encoder(X_filled):
    contact_encoder = OneHotEncoder(handle_unknown='ignore', sparse_output=False)
...
def build_poutcome_encoder(X_filled):
    poutcome_encoder = OneHotEncoder(handle_unknown='ignore', sparse_output=False)
