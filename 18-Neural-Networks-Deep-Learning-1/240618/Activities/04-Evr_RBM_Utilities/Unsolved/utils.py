...
def weights():
    ...
    weight_settings = pd.read_csv("../Solved/rbm_weights.csv")
...
def hidden_bias():
    ...
    hidden_bias_settings = pd.read_csv("../Solved/hidden_layer_bias.csv")
...
def visible_bias():
    ...
    visible_bias_settings = pd.read_csv("../Solved/visible_layer_bias.csv")
